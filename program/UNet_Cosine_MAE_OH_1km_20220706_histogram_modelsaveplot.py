...
modelname = 'dist_Unet_CD_OH_20220706_lr0_0001_modelsave'
...
# nohup python3 ___.py > /home/bssuh/program/nohup_log/___.txt 2>&1 &   
...
# Error Histogram for each epoch(hist)
    ...
    histplotdir = os.path.join(checkpointdir, histname)    #/home/bssuh/program/model/dist_cnn_seq/modelplot.png
